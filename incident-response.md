...
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) - bulk\_extractor is a computer forensics tool that scans a disk image, a file, or a directory of files and extracts useful information without parsing the file system or file system structures. Because of ignoring the file system structure, the program distinguishes itself in terms of speed and thoroughness
...
* [threat\_note](https://github.com/defpoint/threat_note) - A lightweight investigation notebook that allows security researchers the ability to register and retrieve indicators related to their research  
...
* [mac\_apt - macOS Artifact Parsing Tool](https://github.com/ydkhatri/mac_apt) - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files
...
* [domfind](https://github.com/diogo-fernan/domfind) - _domfind_ is a Python DNS crawler for finding identical domain names under different TLDs.
...
* [Binaryforay](http://binaryforay.blogspot.co.il/p/software.html) - list of free tools for win forensics \([http://binaryforay.blogspot.co.il/](http://binaryforay.blogspot.co.il/)\)
